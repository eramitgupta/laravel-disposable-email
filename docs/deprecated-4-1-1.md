---
title: Deprecated in 4.1.1
description: Deprecated and removed API notes for Laravel Disposable Email 4.1.1.
head:
  - - meta
    - name: keywords
      content: laravel disposable email 4.1.1 deprecated, DisposableEmail removed, Disposable facade migration
---

# Deprecated in 4.1.1

Version `4.1.1` moves runtime checks to the shorter `Disposable` facade API.
